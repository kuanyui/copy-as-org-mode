> `html2org` is forked from html-to-markdown converter[turndown](https://github.com/mixmark-io/turndown), with plugin (https://github.com/mixmark-io/turndown-plugin-gfm)
