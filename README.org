...
#+begin_html
<blockquote>
I release all my software projects with <b><code>WTFPL</code>, <code>GPLv3</code>, <code>MIT</code>, or <code>MPL</code> licenses</b>. If my works are usable to you, please consider to donate to <b>reduce my business hours to make more free and open source projects for this world</b>:
<ul>
